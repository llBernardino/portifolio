          ...
          <Heros>
            <Boxtext className='select' data-hidden-class="hidden">
              ...
              <Contacts className='mt-4'>
                ...
                <a className='mx-2' href="https://github.com/llBernardino" target="_blank" rel='noreferrer'><img className='mt-2' alt='github' src="https://img.shields.io/badge/Github-black?style=for-the-badge&logo=github&logoColor=white" /></a>
                <a className='mx-2' href="mailto:cauaberrnardinolima@gmail.com" target="_blank" rel='noreferrer'><img className='mt-2' alt='Gmail' src="https://img.shields.io/badge/Gmail-white?style=for-the-badge&logo=gmail&logoColor=red" /></a>
                <a className='mx-2' href="https://contate.me/devcaua" target="_blank" rel='noreferrer'><img className='mt-2' alt='whatsapp' src="https://img.shields.io/badge/WhatsApp-25D366?style=for-the-badge&logo=whatsapp&logoColor=white" /></a>
              </Contacts>
            </Boxtext>
